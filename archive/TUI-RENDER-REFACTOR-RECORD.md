...
> **归档说明**：本文档记录 2026-09 渲染管线重构（主线 A 契约迁移 + 主线 B Box 排版模型）的实施过程与踩坑，供追溯历史决策。当前实现口径见 `TUI/docs/IMPLEMENTATION.md`，设计见 `TUI/docs/design/DESIGN.md`，规格见 `TUI/docs/SPEC.md`。
