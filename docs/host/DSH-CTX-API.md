...
> 来源：官方 `deepseek-harness` clone（`~/GithubRepos/deepseek-harness`），研读基线 `dsh-v0.1.5-rc.3` = commit `a4c74a91e0`；**0.1.7-rc.2 的接口差异另见 `docs/host/HOST-UPGRADE-0.1.7-rc.2.md`**（本文件尚未按 rc.2 整体复读）。
