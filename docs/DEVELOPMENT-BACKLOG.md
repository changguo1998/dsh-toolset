...
> 基线：dsh `dsh-v0.1.5-rc.2`（`fb2c4b9e69`；原为 `0.1.2-rc.1`/`a66e470204`，2026-09 更新）；两文档中重叠项已合并（list↔任务树序列化、audit↔RET 验收路由、glla goal↔契约起草）。实现时以根目录 `DSH-CTX-API.md`（0.1.5-rc.2 契约）对齐宿主接口。
